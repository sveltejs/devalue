...
/** @typedef {{ nodes: number, sources: number, new_custom: number, validated: number, opaque: number, references: number, pending: number, native_pending: number, active: number, availability: number, anchor: number, slot: number, collection: number, local: number }} TransactionCheckpoint */
